...
Pour la documentation sur l'ajout d'applications, les strat�gies de d�ploiement (Argo Rollouts, Image Updater), ainsi que la **gouvernance GitHub** (Protections de branche et PR reviews), veuillez consulter le README du d�p�t d'applications : [aws-gitops-apps](https://github.com/alex-dembele/aws-gitops-apps).
